...
module.exports = {
  ...
  async execute(interaction, client) {
    ...
    let db = await blockedGuids.findOne({ client_id: process.env.AppID });
    if (db.guilds.includes(interaction.guild.id)) {
      return await interaction.reply({
        content: "This guild has been blocked from using interactions with this bot.",
        ephemeral: true
      })
    } else
